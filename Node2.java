...
public class Node2 extends Thread
{
	   ...
	   public static void main(String args[])throws IOException
	   {
		   ...
		   System.out.println("Creating Sender thread for Node2... " );
		   Node2 p1_thread1 = new Node2("Node2_Sender_Thread");
		   p1_thread1.start();
		    
		   System.out.println("Creating Receiver thread for Node2... " );
		   Node2 p1_thread2 = new Node2("Node2_Receiver_Thread");
		   p1_thread2.start();
		   }
	   }
	   ...
	   public void run()
	   {
	      ...
	      try 
	      {
	         if(thread_pr1_name.equalsIgnoreCase("Node2_Sender_Thread"))
	         {
	        	fncall_send();
	            Thread.sleep(80);
	         }
	   ...
	   void fncall_recv() throws IOException, SocketException {
		   ...
		   DatagramSocket server_socket = new DatagramSocket(8081);
