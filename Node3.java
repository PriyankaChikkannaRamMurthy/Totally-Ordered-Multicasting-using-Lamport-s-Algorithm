...
public class Node3 extends Thread
{
	   ...
	   public static void main(String args[])throws IOException
	   {
		   ...
		   Node3 p1_thread1 = new Node3("Node3_Sender_Thread");
		   p1_thread1.start();
		    
		   System.out.println("Creating Receiver thread for Node1... " );
		   Node3 p1_thread2 = new Node3("Node3_Receiver_Thread");
		   p1_thread2.start();
		   }
	   }
	   ...
	   public void run()
	   {
	      ...
	      try 
	      {
	         if(thread_pr1_name.equalsIgnoreCase("Node3_Sender_Thread"))
	         {
	        	fncall_send();
	            Thread.sleep(80);
	         }
	   ...
	   void fncall_recv() throws IOException, SocketException {
		   ...
		   DatagramSocket server_socket = new DatagramSocket(8082);
		   
		   for(i=0;i<27;i++) {
		   byte recv_buff[] = new byte[500];
